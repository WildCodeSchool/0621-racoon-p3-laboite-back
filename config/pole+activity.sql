...
VALUES
  (
    ...
    'conciergerie-services-01.jpg',
    1,
    'Services aux particuliers'
  ),(
    17,
    'Services aux entreprises : service de coursier, livraisons clients, débarras des emballage, nettoyage de chantiers ou véhicules, voiturier, entretien des locaux avec des produits non polluants et respectueux de l’environnement, mise à disposition de personnel en renfort à titre ponctuel…',
    'conciergerie-services-02.jpg',
    1,
    'Services aux collectivités'
  ),(
    18,
    'Services aux collectivités : entretien du cimetière, entretien des chemins de randonnée et des bords de Cher, ambassadeurs de tri auprès des usagers de la déchetterie ou des entreprise, mise à disposition de personnel en renfort à titre ponctuel…',
    'conciergerie-services-03.jpg',
    1,
...
VALUES
  (
    ...
    'La Conciergerie',
    'concierge-bell',
    '\rmet à la disposition des habitants, collectivités et entreprises de la communauté de communes Bléré-Val de Cher (autour de Chenonceaux) une conciergerie territoriale aux multiples services.',
    'conciergerie-banner.jpg',
    'Une adhésion annuelle de 5 € à notre association vouspermet d’accéder à l’ensemble des services dont les tarifs sont détaillés ci-après. Le coût de nos services ou travaux à domicile donne droit, pour les particuliers, à réduction d’impôt.\nAu-delà de services généraux répertoriés ci-dessous, nous pouvons nous adapter vos besoins.\n\nPour toute demande, notre équipe vous accueille au 02 00 70 07 00',
    'conciergerie-func.jpeg',
    '02 00 70 07 00',
    ...
    'Pôle Végétal',
    'leaf',
    'se sent proche de la nature et du végétal. À ce titre, elle propose une activité grands jardins qui se déploie dans trois domaines complémentaires et utiles au territoire, à ses habitants et à son développement touristique.',
    'vegetal-banner.jpeg',
    'Mise en culture d’espaces inutilisés, proches des bords du Cher avec une visée pédagogique pour les salariés de La boîte d’à côté et les visiteurs. Habillage de la  zone de végétaux et de senteurs, tout en montrant différentes techniques de culture adaptées à nos modes de vie et à tout public : permaculture, culture sur lasagnes, culture à mi-hauteur, etc.',
    'vegetal-func.jpeg',
    '02 00 70 07 00 ',
    'bonjour@laboitedacote.fr',
    'vegetal-mini.jpg',
...
-- Dump completed on 2021-10-11 16:44:22